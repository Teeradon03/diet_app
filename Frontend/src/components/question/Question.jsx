...
const Question = () => {
  const questions = [
    ...
    },
    {
      ...
      options: ["ช้าเเต่มั่นคง", "ปานกลาง", "เร็วที่สุด"],
    },
    {
      id: 10,
  ...
  const handleNextQuestion = () => {
    ...
    if (questions[currentQuestion].id >= 1 && questions[currentQuestion].id <= 9) {
      console.log("Question ID:", questions[currentQuestion].id); //id ข้อ
      console.log("Question:", questions[currentQuestion].question); //คำถาม
      console.log("Answer:", selectedOption); //ข้อที่เลือก
                          ...
                          <div key={index}>
                            <button
                              ...
                              className={`answer-button ${
                                selectedOption === option ? "highlight" : ""
                              }`}
                              onClick={(event) =>
