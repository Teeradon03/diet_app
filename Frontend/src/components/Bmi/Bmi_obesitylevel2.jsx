  ...
  return (
    <div>
      <div className={styles.Bmi1}>
        ...
        <div className={styles.childbmi} style={boldTextStyle}>BMI  25 - 29.90</div>
        <div className={styles.childbmi} style={boldTextStyle}>อยู่ในเกณฑ์   อ้วน/อ้วนระดับ 2</div>
        <div className={styles.childbmi} style={boldTextStyle}>ภาวะเสี่ยงต่อโรค   อันตรายระดับ 2</div>
        <br />
