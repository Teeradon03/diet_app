  ...
  return (
    <div>
      <div className={styles.Bmi1}>
        ...
        <div className={styles.childbmi} style={boldTextStyle}>BMI  มากกว่า 30</div>
        <div className={styles.childbmi} style={boldTextStyle}>อยู่ในเกณฑ์   อ้วน/อ้วนระดับ 3</div>
        <div className={styles.childbmi} style={boldTextStyle}>ภาวะเสี่ยงต่อโรค   อันตรายระดับ 3</div>
        <br />
