...
import './Menu.css';
import { menus } from './list08'; //meun 08.00
...
const Menu08 = () => {
  ...
  const handleOk = () => {
    if (!selectedMenu) {
      setError('');
      window.location.href = "/fate2/Menu08";
    }
    ...
    <div className='font-family'>
      ...
      <div className='contener-button'>
        ...
        {isDataSaved && (
         ...
         {/* Conditionally render the error message popup */}
         {error && (
          <Modal title="Error" open={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
